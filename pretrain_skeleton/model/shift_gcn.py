...
class Shift_gcn(nn.Module):
    def __init__(self, in_channels, out_channels, A, num_point, coff_embedding=4, num_subset=3):
        ...
        index_array = np.empty(num_point*in_channels).astype(np.int64)
        ...
        index_array = np.empty(num_point*out_channels).astype(np.int64)
        for i in range(num_point):
...
class TCN_GCN_unit(nn.Module):
    def __init__(self, in_channels, out_channels, A, num_point, stride=1, residual=True):
        ...
        self.gcn1 = Shift_gcn(in_channels, out_channels, A, num_point)
...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, graph_args=dict(), in_channels=3):
        ...
        self.l1 = TCN_GCN_unit(3, 64, A, num_point, residual=False)
